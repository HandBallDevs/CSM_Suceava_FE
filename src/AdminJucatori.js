      ...
      <div className="Container-ADMJucatori">
        <div className="Menu-ADMJucatori">
          ...
          <div className="options_ADMJucatori">
            ...
            <Link to="/adminjucatori" className="ADMJucatori_options1">
            <motion.div whileHover={{ scale: 1.1, transition: { duration: 0.3 } }}>
              Jucatorii Seniori
              </motion.div>
              </Link>
            ...
            <Link to="/adminstaff" className="ADMJucatori_options">
            <motion.div whileHover={{ scale: 1.1, transition: { duration: 0.3 } }}>
              Staff
              </motion.div>
              </Link>
        ...
        <div className="Workspace-ADMJucatori">
             <div className="Workspace-row-ADMJucatori">
                ...
                <label className="label-filter-ADMJucatori" htmlFor="cauta">
          Cauta jucator:
        </label>
        <input
          type="text"
          id="cauta"
          name="cauta"
          className="textbox-filter-ADMJucatori"
          value={searchName}
          onChange={handleSearchNameChange}
        />
        <label className="label-filter-ADMJucatori" htmlFor="filtreaza">
          Filtreaza :
        </label>
        <input
          type="text"
        ...
        />
                ...
                <Link to="/adaugajucator" className="button-adauga_jucator-ADMJucatori">
                <motion.div whileHover={{ scale: 1.1, transition: { duration: 0.3 } }}>
